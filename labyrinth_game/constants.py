...
ROOMS = {
    ...
    'dungeon': {
          'description': 'Подземелье, наполненное скелетами, \
            старой мебелью и золотом.',
          'exits': {'north': 'trap_room', 'south': 'exit'},
          'items': ['gold'],
          'puzzle': ('Чтобы победить скелетов и забрать золото \
                     вычислите квадратный корень из 16', 4.0)
    },
    'exit': {
...
COMMANDS = {
    ...
    "take <item>": "взять предмет в комнате",
